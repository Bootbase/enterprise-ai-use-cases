...
title: "References — UC-041: Autonomous Regulatory Change Intelligence and Compliance Orchestration with Agentic AI"
uc_id: "UC-041"
...
permalink: /use-cases/autonomous-regulatory-change-intelligence-agentic-ai/references/
---
...
|----|----------|------|----------------|------|
| `UC` | UC-041 research brief | Local source | Problem statement, constraints, success criteria, and operating assumptions used for scenario calculations | [use-case.md](./index.md) |
...
| Scenario calculations | Derived from `UC` plus published metrics; labeled `estimated` throughout. |
