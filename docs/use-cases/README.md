...
docs/use-cases/
  ...
  industry-specific/
    ...
    UC-520-wildfire-detection-early-warning/
    UC-521-semiconductor-yield-optimization/
    UC-522-railway-predictive-maintenance/
    UC-523-oil-gas-production-optimization/
    UC-524-waste-sorting-material-recovery/
    UC-525-real-time-payment-fraud-detection/
```
