# UC-040: Autonomous Knowledge Synthesis and Research Copilot for Management Consultants with Agentic AI
...
|-----------------|-------------------------------------------|
| **Cost**        | Junior consultant fully-loaded cost is $200-400/hour (US/EU); a single 8-week engagement team of 4-6 consultants represents $1.5-3M of labor. McKinsey reports Lilli has shifted ~$12M of monthly labor from research to higher-value synthesis ([McKinsey, 2024](https://www.mckinsey.com/capabilities/tech-and-ai/how-we-help-clients/rewiring-the-way-mckinsey-works-with-lilli)). Across the global consulting industry (~$300B market in 2024 per Statista), even a 10% productivity gain on knowledge work represents $15-30B/year of redeployable capacity. |
| **Time**        | Building a project scoping deck used to take ~2 days at McKinsey and now takes under 3 hours with Lilli ([Building Creative Machines, 2024](https://www.buildingcreativemachines.com/p/lilli-mckinseys-generative-ai-platform)). Average Lilli session saves ~6 minutes versus manual lookup; 17 prompts/week/user across 32,000 active users compounds to 50,000+ hours reclaimed per month. The Harvard-BCG randomized field experiment with 758 consultants found AI users completed 12.2% more tasks, 25.1% faster, with 40%+ higher quality on the tasks AI was suited to ([HBS Working Paper 24-013, Dell'Acqua et al., 2023](https://www.hbs.edu/faculty/Pages/item.aspx?num=64700)). |
